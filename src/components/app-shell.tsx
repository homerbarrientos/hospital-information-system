...
const operations=[["/operations/or","Operating Room",Activity],["/operations/dr","Delivery Room",Baby],["/operations/dietary","Dietary",Utensils],["/operations/materials","Materials Inventory",Package],["/operations/purchasing","Purchasing",PackagePlus],["/operations/philhealth","PhilHealth Claims",FileHeart]]as const;
