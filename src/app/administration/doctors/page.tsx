...
export default async function DoctorsPage() {
  ...
  return <>
    ...
    <DoctorsWorkspace doctors={doctors} departments={departments || []} facilityId={facilityId} referenceOptions={(referenceOptions||[]).map(option=>({code:option.code,label:option.label,group:groupById.get(option.group_id)}))}/>
  </>;
}
