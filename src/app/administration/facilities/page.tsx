...
export default async function FacilitiesPage(){
 ...
 const[{data:facility,error:facilityError},{data:departments,error:departmentError},{data:wards,error:wardError},{data:beds,error:bedError},{data:buildings},{data:services}]=await Promise.all([
