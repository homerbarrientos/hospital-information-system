...
export default async function Patients() {
  ...
  return <AppShell><PageHeading eyebrow="Master patient index" title="Patients" description="Search first to prevent duplicate patient records."/>{error && <div className="form-error">{error.message}</div>}<PatientWorkspace patients={(patients || []) as Patient[]} facilityId={facilityId} referenceOptions={referenceOptions}/></AppShell>;
}
